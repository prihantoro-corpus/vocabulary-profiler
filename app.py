...
if st.session_state['view'] == 'dictionary':
    ...
    st.subheader("📝 Lexicographic Entry Summary")
    ...
    <div style="background-color: #1a1a1a; padding: 25px; border-radius: 12px; border: 1px solid #444; color: #eee; font-family: 'Inter', sans-serif; line-height: 1.6;">
        ...
        <div style="margin-top: 30px; font-size: 0.85em; border-top: 1px solid #333; padding-top: 15px;">
            <b style="color: #aaa;">dictionary link:</b> <a href="{pronunciation_url(current_dict_word)}" target="_blank" style="color: #00AAAA; text-decoration: none;">{pronunciation_url(current_dict_word)} ↗</a>
            <br>
            <b style="color: #aaa;">thesaurus link:</b> <a href="{thesaurus_url(current_dict_word)}" target="_blank" style="color: #00AAAA; text-decoration: none;">{thesaurus_url(current_dict_word)} ↗</a>
        </div>
    </div>
    """
