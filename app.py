...
def analyze_text(text, tagger, jlpt_lists):
    ...
    # For Readability/JLPT formulas, we exclude punctuation (補助記号)
    ...
    # Full POS Stats (based on all tokens)
